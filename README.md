...
|-|-|-|
|**src/win.c**|**758**|**can we shift here only by offset?**|
|**src/main.c**|**1**|**v0.3: errno comments and properly errno handling everywhere.**|
|**src/main.c**|**2**|**v0.3: Rename ed_proc_*_key to ed_try_proc_*_key?**|
|**src/main.c**|**3**|**v0.3: Check using valgrind and eyes that all memory is freed on errors.**|
|**src/main.c**|**4**|**v0.3: Try to read file chunks or try to use mmap.**|
