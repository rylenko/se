...
|**src/main.c**|**4**|**v0.5: Undo operations. Also rename "del" to "remove" where needed.**|
|**src/main.c**|**5**|**v0.5: Add key settings for escape sequences. For example, CFG_KEY_MV_UP_2 = "..."**|
|**src/main.c**|**6**|**v0.5: Add local clipboard. Use it in functions.**|
|**src/main.c**|**7**|**v0.5: Xclip patch to use with local clipboard.**|
|**src/main.c**|**8**|**v0.6: Support huge files: read chunks or try mmap**|
|**src/main.c**|**9**|**v0.6: Add tests.**|
|**src/main.c**|**10**|**v0.7: Make code patching easier.**|
|**src/main.c**|**11**|**v0.7: Add more error codes in docs.**|
|**src/main.c**|**12**|**v0.7: Save to spare dir on error.**|
