...
# Code files
SRC = src/buf.c src/color.c src/editor.c src/err.c src/main.c src/row.c \
...
src/editor.o: src/color.h src/editor.h src/key.h src/math.h src/row.h \
	src/str_util.h src/term.h
src/err.o: src/err.h
